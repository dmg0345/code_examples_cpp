...
TEST_F(BinaryTreePointersTest, Integer)
{
    ...
    ASSERT_EQ(btint.contains(0U), 0U);
    ASSERT_EQ(btint.contains(2U), 2U);
    ASSERT_EQ(btint.contains(4U), 4U);
    ASSERT_EQ(btint.contains(7U), 7U);
    ASSERT_EQ(btint.contains(9U), 9U);
    ASSERT_EQ(btint.contains(12U), 12U);
    ASSERT_EQ(btint.contains(14U), 14U);
}
