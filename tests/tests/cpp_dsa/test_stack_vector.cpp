...
using CppDSA::Stack::Vector::Stack;
 ...
 */
namespace Tests::CppDSA::StackVector
{
 ...
 */
TEST_F(StackVectorTest, Integer)
{
    Stack<int> sint;
    int tmp = 0U;
 ...
 */
TEST_F(StackVectorTest, ConstantInteger)
{
 ...
 */
TEST_F(StackVectorTest, ConstantLog)
{
    Stack<const Log> sclog(5);
    Log tmp;
